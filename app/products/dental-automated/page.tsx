      ...
      <main id="main">
        ...
        <ContentSection background="panel">
          <div id="orchestration" className="scroll-mt-28">
            <RevealContainer className="mb-10">
              <SectionHeader eyebrow="Front Desk Orchestration" title="One coordinator, seven specialists." description="Trisha maintains a real-time view across every other agent — what's stalled, what's working, and what needs a human." />
            </RevealContainer>
          ...
          <DeploymentSection eyebrow="Deployment Experience" title="From first conversation to a live workforce.">
            <StepFlow
              steps={[
                ...
                { title: 'Configuration', timeframe: 'Hours 1–3', description: 'Each agent is configured against your real scheduling and recall rules.' },
