...
export const metadata: Metadata = {
  ...
  description:
    'Medical Automated is the same coordinated 8-agent AI workforce as Dental Automated, adapted for the medical front office — connecting directly into the EHR your practice already runs on.',
};
...
export default function MedicalAutomatedPage() {
  return (
    <>
      ...
      <SoftwareApplicationSchema name="Medical Automated" description="The same coordinated 8-agent AI workforce as Dental Automated, adapted for the medical front office and connecting directly into the EHR your practice already runs on." />
      <FAQSchema faqs={faqs} />
      <main id="main">
        <HeroLayout
        ...
        <ContentSection background="panel" id="why">
          <RevealContainer className="mb-10">
            <SectionHeader
              eyebrow="Why This Exists"
              title="A medical front office runs on referrals, insurance, and follow-up — not just calls."
              description="That rhythm is genuinely different from dental operations, which is why the same 8-agent platform is configured differently here, not relabeled. Expand any card for detail."
            />
          </RevealContainer>
        ...
        <ContentSection id="agents">
          <RevealContainer className="mb-10">
            <SectionHeader eyebrow="Meet the AI Workforce" title="Eight agents, each owning one responsibility." />
          </RevealContainer>
        ...
        <ContentSection background="panel" id="orchestration">
          <RevealContainer className="mb-10">
            <SectionHeader eyebrow="Front Office Orchestration" title="One coordinator, seven specialists." description="Trisha maintains a real-time view across every other agent — what's stalled, what's working, and what needs a human." />
          </RevealContainer>
        ...
        <ContentSection background="panel" id="matrix">
          <RevealContainer className="mb-10">
        ...
        <ContentSection background="panel" id="integrations">
          <RevealContainer className="mb-10">
            <SectionHeader
        ...
        <DeploymentSection eyebrow="Deployment Experience" title="From first conversation to a live workforce." id="deployment">
          <StepFlow
            steps={[
              ...
              { title: 'Configuration', timeframe: 'Hours 1–3', description: 'Each agent is configured against your real referral, insurance, and follow-up patterns.' },
        ...
        >
          <SecurityStackDiagram
            layers={[
              { name: 'Access Control', description: 'Every agent action is scoped and authenticated.' },
