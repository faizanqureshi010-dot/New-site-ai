...
const capabilities = [
  ...
  { title: 'Scheduling Complexity', body: 'Availability, provider rules, and rescheduling compete for attention.' },
...
const faqs = [
  ...
  { q: 'Can the agent be configured for how our business specifically operates?', a: 'Yes — configuration against your real operations happens before the agent takes a single live call.' },
  ...
  { q: 'What happens when the agent encounters something it can\'t handle?', a: 'It recognizes the limit and hands off to a person, live, with context — it does not guess.' },
...
export default function BookingAgentPage() {
  return (
    <>
      ...
      <SoftwareApplicationSchema name="AISC Booking Agent" description="An enterprise AI agent that owns call handling and scheduling end to end, connected directly into the system your business already runs on." />
      <FAQSchema faqs={faqs} />
      ...
      <main id="main">
        ...
        <HeroLayout
          ...
          description="One AI agent, one job, done completely: it answers, checks real availability, and books the appointment live — synced straight into the system you already run. No new hardware. Live in 48 hours."
          ...
          <DeploymentSection eyebrow="Deployment Experience" title="From first conversation to a live, supported platform.">
            <StepFlow
              steps={[
                ...
                { title: 'Configuration', timeframe: 'Hours 1–2', description: 'The agent is configured against your specific rules and availability.' },
                ...
                { title: 'Go Live', timeframe: 'Within 48 hrs', description: 'The agent begins handling real calls.' },
