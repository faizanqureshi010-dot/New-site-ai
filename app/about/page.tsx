    ...
    <>
      ...
      <main id="main">
        <HeroLayout
          ...
          description="AI Solution Company is a US-based enterprise AI software company. We build production-ready AI Employees — coordinated agents that take on real operational roles inside real businesses."
