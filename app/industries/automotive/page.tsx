...
const data: IndustryPageData = {
  ...
  heroDescription: 'A dedicated AI agent that owns calls, scheduling, and status updates for repair shops, service centers, and dealership service departments.',
  ...
  deploymentSteps: [
    ...
    { title: 'Configuration', description: 'The agent is configured against your bay availability and service rules.' },
    ...
    { title: 'Go Live', description: 'The agent begins handling real calls.' },
