...
const data: IndustryPageData = {
  name: 'Hotels',
  heroDescription: 'A dedicated AI agent that answers reservation calls, checks live availability, and books guests at any hour.',
  ...
  deploymentSteps: [
    ...
    { title: 'Configuration', description: 'The agent is configured against your real rates and availability rules.' },
