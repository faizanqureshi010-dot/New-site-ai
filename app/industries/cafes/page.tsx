...
const data: IndustryPageData = {
  name: 'Cafés',
  heroDescription: 'A dedicated AI agent built to be fast and exact — handling booking and phone-based requests at the pace a café actually needs.',
  ...
  deploymentSteps: [
    ...
    { title: 'Configuration', description: 'The agent is configured to be fast and precise, matching your real operations.' },
