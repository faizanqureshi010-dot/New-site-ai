...
const data: IndustryPageData = {
  name: 'Restaurants',
  heroDescription: 'A dedicated AI agent that owns reservation calls and table availability, built around how a dining room actually runs during service.',
  ...
  deploymentSteps: [
    ...
    { title: 'Configuration', description: 'The agent is configured against your real seating and availability rules.' },
