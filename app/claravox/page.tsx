...
const facts = [
  ...
  },
  {
    ...
    body: 'No AI agents, no front-office call handling — Claravox is a revenue cycle operations business. It sits under the same parent company, run separately, solving a different problem.',
  },
];
    ...
    <>
      ...
      <main id="main">
        <HeroLayout
          ...
          description="Claravox Healthcare is a separate revenue-cycle management company under AI Solution Company — not an AI agent product, and not another deployment of the 8-agent front office platform. It's a distinct business, built to solve a different problem: getting practices paid correctly and on time."
          primaryAction={
        ...
        <ContentSection>
          <RevealContainer className="mx-auto max-w-[720px] text-center">
            <SectionHeader eyebrow="Why It's Here" title="Why a billing company shows up on an AI agent site." align="center" />
            <p className="mt-4 text-slate">
              AI Solution Company and Claravox Healthcare share a parent company, not a product. If you came here looking for the 8-agent front office
