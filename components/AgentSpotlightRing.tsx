  ...
  return (
    <div className="mx-auto w-full" style={{ maxWidth: size }}>
      <div className="relative">
        <svg viewBox={`0 0 ${vb} ${vb}`} className="w-full" role="img" aria-label="Eight coordinated AI agents animated around the AISC platform">
          <defs>
      ...
      <div className="glass mx-auto mt-6 min-h-[52px] max-w-sm rounded-token px-4 py-3">
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <span className="font-semibold text-ink">{reduceMotion ? 'All agents' : agents[active].name}</span>
