...
const deploymentSubmenu = [
  { name: 'Meet the Agents', hrefSuffix: '#agents', icon: Users },
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="absolute left-1/2 top-full z-40 mt-2 w-[420px] -translate-x-1/2 rounded-2xl border border-line bg-panel/95 backdrop-blur-xl p-3 shadow-[0_30px_60px_-20px_rgba(0,0,0,0.6)]"
          >
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            exit={{ opacity: 0, y: 8 }}
            transition={{ duration: 0.18, ease: [0.16, 1, 0.3, 1] }}
            className="absolute left-1/2 top-full z-40 mt-2 w-[320px] -translate-x-1/2 rounded-2xl border border-line bg-panel/95 backdrop-blur-xl p-3 shadow-[0_30px_60px_-20px_rgba(0,0,0,0.6)]"
          >
            <div className="flex flex-col gap-1">
              <FlyoutRow
                name="AISC Booking Agent"
                desc="AI booking & voice agent, standalone"
