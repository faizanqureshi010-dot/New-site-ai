    ...
    <>
      ...
      <main id="main">
        <HeroLayout
          ...
          primaryAction={<Button href="/book-demo" size="lg">Book a Demo Instead</Button>}
          visual={
              ...
              return (
                <StaggerItem key={r.label}>
                  <button
                    ...
                    className={`h-full w-full rounded-token border p-4 text-left transition-colors ${
                      active ? 'border-blue/50 bg-panel2' : 'border-line bg-panel hover:border-line/70'
                    }`}
                  >
