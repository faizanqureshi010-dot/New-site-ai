 ...
 * links already say "Book a Demo" etc., so we don't double up a label on top
...
export default function CustomCursor() {
  ...
  const shapeBackground =
    mode === 'pill' ? (premium ? '#EC4899' : '#6366F1') :
    mode === 'card' ? '#A855F7' :
    mode === 'diagram' ? '#00A8C8' :
    mode === 'text' ? '#6366F1' :
    'rgba(120,62,213,0.55)'; // default/moving state — small, semi-transparent, purple identity per spec
