...
export const agents: Agent[] = [
  {
    ...
    summary: 'AI call handling, live answer, intent detection, and intelligent routing — the first voice a caller hears, every time.',
    scenario: {
  ...
  },
  {
    ...
    summary: 'Workflow orchestration, team oversight, task management, and operational efficiency — the coordinator who knows what every other agent is doing, in real time.',
    scenario: {
    ...
    workflow: [
      { icon: 'Network', label: 'Activity Monitored', detail: 'Maintains a real-time view across every other agent — what\'s stalled, what\'s working, what needs attention.' },
